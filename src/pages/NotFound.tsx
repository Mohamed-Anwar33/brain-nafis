  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-50 font-cairo" dir="rtl">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
        <Ghost className="absolute top-20 right-20 w-16 h-16 text-slate-400 animate-bounce" style={{ animationDuration: "3000ms" }} />
        <Search className="absolute bottom-40 left-20 w-12 h-12 text-blue-400 animate-bounce delay-500" style={{ animationDuration: "4000ms" }} />
        <AlertCircle className="absolute top-40 left-1/4 w-10 h-10 text-red-400 animate-bounce delay-200" style={{ animationDuration: "3500ms" }} />
        <Sparkles className="absolute bottom-20 right-1/3 w-14 h-14 text-yellow-400 animate-bounce delay-700" style={{ animationDuration: "4500ms" }} />
      </div>
