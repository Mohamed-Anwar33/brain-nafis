...
export default function AdminCentralExamLayout() {
  ...
  const navItems = [
    { path: "/admin/central-exam", icon: LayoutDashboard, label: "لوحة التحكم" },
    { path: "/admin/central-exam/settings", icon: Settings, label: "الإعدادات العامة" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:hidden sticky top-0 z-50 bg-card border-b border-border p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg text-slate-800">الاختبار المركزي</span>
        </div>
        <div className="w-10" />
      </div>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-bold text-lg text-slate-800">الاختبار المركزي</h1>
                  <p className="text-xs text-slate-500">إدارة الاختبارات المقررة</p>
                </div>
              </div>
